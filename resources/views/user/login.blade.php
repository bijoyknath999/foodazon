      ...
      <div class="ms-auth-container">
        ...
        <div class="ms-auth-col">
          <div class="ms-auth-form">
            <form class="needs-validation" novalidate="" action="{{ route('user.check') }}" method="post">
           ...
           @csrf
              ...
              <p class="mb-0 mt-3 text-center">Don't have an account? <a class="btn-link" href="{{route('user.register')}}">Create Account</a> 
              </p>
            </form>
          </div>
        </div>
