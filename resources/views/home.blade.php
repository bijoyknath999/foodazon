...
<!-- Mirrored from slidesigma.com/themes/html/costic/pages/prebuilt-pages/coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Feb 2020 13:14:06 GMT -->
<head>
...
<body class="ms-body ms-primary-theme">
  ...
  <script src="{{asset('/assets/js/jquery.countdown.min.js')}}">
  </script>
