    ...
    <div class="ms-panel-body">
      ...
      <div class="table-responsive">
        ...
        <div class="col-md-6 mb-4">
          ...
          <form class="form-inline mr-auto mb-4" method="GET" action="{{route('admin.customerslist')}}" ">
        ...
        <tbody>
          ...
          @if($item->verified =='1')
            <tr>
                ...
                <td>{{$item["email"]}}</td>
                <td>₹{{$item["balance"]}}</td>
                <td><button onclick="document.location='{{"/admin/addbalance/".$item["username"]}}'" class="btn btn-success btn-rounded btn-sm my-0 waves-effect waves-light" type="submit">Add Balance</button></td>
            </tr>
